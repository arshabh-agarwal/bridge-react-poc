    ...
    packagerOptions: {
      webpackConfig: {
        ...
        plugins: [
          ...
          // app boots; @poc/remote-app-ember-adapter's `remote-loader` service picks that instance up by name.
          ...
          new ModuleFederationPlugin({
            ...
            remotes: {
              provider_remote18: 'provider_remote18@http://localhost:3018/mf-manifest.json',
              provider_remote19: 'provider_remote19@http://localhost:3019/mf-manifest.json',
            },
